...
String addrToDevice(byte addr){
    ...
    switch (addr) {
        ...
        case 0x76 : { return F("BME280, BMP280, BME680 Temperature Pressure [Humidity][VOX] sensor"); }
        case 0x77 : { return F("BME280, BMP280, BME680 Temperature Pressure [Humidity][VOX] sensor"); }
